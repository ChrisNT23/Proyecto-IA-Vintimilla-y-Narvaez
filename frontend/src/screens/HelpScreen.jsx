...
// import dev2Pic from '../assets/dev2.jpg'; // <-- COMENTADO (archivo no existe / no se encuentra)
  ...
  return (
    <Container className="help-screen my-5">
      ...
      <Row className="justify-content-center mt-5">
        ...
        <Col xs={12} md={6} lg={4} className="mb-4 d-flex justify-content-center">
          <Card className="developer-card">
            <div className="card-img-wrapper">
              <Card.Img src={dev1Pic} alt="Foto de Thyara Vintimilla" />
            </div>
            <Card.Body>
        ...
        {/*
        // =========================
        // Desarrollador 2 (comentado por ahora)
        // =========================
        <Col xs={12} md={6} lg={4} className="mb-4 d-flex justify-content-center">
          <Card className="developer-card">
            <div className="card-img-wrapper">
              <Card.Img src={dev2Pic} alt="Foto del Desarrollador 2" />
            </div>
            <Card.Body>
              <Card.Title className="developer-name">
